...
// pin modes
#define FM_INPUT                0x00 // defined in wiring.h
#define FM_OUTPUT               0x01 // defined in wiring.h
#define FM_ANALOG               0x02 // analog pin in analogInput mode
#define FM_PWM                  0x03 // digital pin in PWM output mode
#define FM_SERVO                0x04 // digital pin in Servo output mode
#define FM_SHIFT                0x05 // shiftIn/shiftOut mode
#define FM_I2C                  0x06 // pin included in I2C setup
...
protected:
	/* Use stream for serial input/output */
	CStream *stream;
	...
	virtual void currentReportDigital(byte pin, int val) {}
